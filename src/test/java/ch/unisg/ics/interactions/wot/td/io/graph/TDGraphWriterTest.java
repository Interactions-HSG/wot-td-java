...
public class TDGraphWriterTest {
  ...
  @Test
  public void testWriteDigestSecuritySchemeOneToken() throws RDFParseException, RDFHandlerException,
    IOException {
    String testTD = PREFIXES +
      "<http://example.org/#thing> a td:Thing ;\n" +
      "    dct:title \"My Thing\" ;\n" +
  ...
  @Test
  public void testBearerSecurityScheme() throws RDFParseException, RDFHandlerException,
    IOException {
    String testTD = PREFIXES +
      "<http://example.org/#thing> a td:Thing ;\n" +
      "    dct:title \"My Thing\" ;\n" +
  ...
  @Test
  public void testPSKSecurityScheme() throws RDFParseException, RDFHandlerException,
    IOException {
    String testTD = PREFIXES +
      "<http://example.org/#thing> a td:Thing ;\n" +
      "    dct:title \"My Thing\" ;\n" +
