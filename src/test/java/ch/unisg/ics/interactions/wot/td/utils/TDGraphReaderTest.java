...
public class TDGraphReaderTest {
  ...
  private static final String TEST_IO_SIMPLE_OBJECT =
      "        td:input [\n" + 
      "            a js:ObjectSchema ;\n" + 
      "            js:properties [\n" + 
      "                a js:BooleanSchema ;\n" +
  ...
  private static final String TEST_IO_SIMPLE_SEMANTIC_OBJECT =
      "        td:input [\n" + 
  ...
  public void testReadOneActionOneObjectInput() {
    TDGraphReader reader = new TDGraphReader(TEST_IO_HEAD + TEST_IO_SIMPLE_OBJECT + TEST_IO_TAIL);
